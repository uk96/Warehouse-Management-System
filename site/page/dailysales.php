                    ...
                    <div class="navigation-bar-division"> 
                        ...
                        <div class="right-division navigation-low-height">
                            <div class="navigation-tab <?php if($userName == "") { echo'hide';}?>">
                                ...
                                <a href="../page/dailysales.php" class="navigation-tab-item-active">Daily Sales</a>
            ...
            <div class="body">
                <div class="container">
                    <div class="navigation-bar-division lower-navigation-bar">
                        <div class="left-division page-name bold">Daily Sales Data</div>
                        <div class="right-division">
                                <div class="navigation-tab <?php if($userName == "") { echo'hide';}?>">
                        ...
                        <div class="filter-input-area">
                            <div class="filter-input-line">
                                ...
                                <div class="input-box-filter small-margin-left">
                                    <input type="date" class="filter-input text-input text-font-family" placeholder=" " id="salesDate"  name="salesDate" value="">
                                    <label for="salesDate" class="text-input-label">Sales Date</label>
                                </div>
                            </div>
                        </div>
