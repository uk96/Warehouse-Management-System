                    ...
                    <div class="navigation-bar-division"> 
                        ...
                        <div class="right-division navigation-low-height">
                            <div class="navigation-tab <?php if($userName == "") { echo'hide';}?>">
                                ...
                                <a href="../page/orders.php" class="navigation-tab-item-active">Orders</a>
            ...
            <div class="body">
                <div class="container">
                    <div class="navigation-bar-division lower-navigation-bar">
                        <div class="left-division page-name bold">Order Data</div>
                        <div class="right-division">
                                <div class="navigation-tab <?php if($userName == "") { echo'hide';}?>">
                        ...
                        <div class="filter-input-area">
                            <div class="filter-input-line">
                                ...
                                <div class="input-box-filter small-margin-left">
                                    <input type="text" class="filter-input text-input text-font-family" placeholder=" " id="invoiceNumber"  name="invoiceNumber" value="">
                                    <label for="invoiceNumber" class="text-input-label">Invoice Number</label>
                                </div>
                            </div>
                            <div class="filter-input-line">
                                <div class="input-box-filter">
                    ...
                    <div id="table-div" class="table-div hide">
                        <table id="table-details" class="details-table order-table-data">
